...
Version  : 1.6.0
Release  : 24
URL      : https://github.com/bats-core/bats-core/archive/v1.6.0/bats-core-1.6.0.tar.gz
Source0  : https://github.com/bats-core/bats-core/archive/v1.6.0/bats-core-1.6.0.tar.gz
...
%prep
%setup -q -n bats-core-1.6.0
cd %{_builddir}/bats-core-1.6.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645829514
...
cp %{_builddir}/bats-core-1.6.0/LICENSE.md %{buildroot}/usr/share/package-licenses/bats/1c44d90b844121642b1219f25b6b8ea3240f8cb9
%make_install
