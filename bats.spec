...
Version  : 1.8.2
Release  : 28
URL      : https://github.com/bats-core/bats-core/archive/v1.8.2/bats-core-1.8.2.tar.gz
Source0  : https://github.com/bats-core/bats-core/archive/v1.8.2/bats-core-1.8.2.tar.gz
...
%prep
%setup -q -n bats-core-1.8.2
cd %{_builddir}/bats-core-1.8.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666220900
