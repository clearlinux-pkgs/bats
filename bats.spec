...
Version  : 1.9.0
Release  : 29
URL      : https://github.com/bats-core/bats-core/archive/v1.9.0/bats-core-1.9.0.tar.gz
Source0  : https://github.com/bats-core/bats-core/archive/v1.9.0/bats-core-1.9.0.tar.gz
...
%prep
%setup -q -n bats-core-1.9.0
cd %{_builddir}/bats-core-1.9.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676307514
